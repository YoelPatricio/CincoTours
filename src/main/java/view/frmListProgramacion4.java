...
public class frmListProgramacion4 extends javax.swing.JDialog {

    DefaultTableModel dtm;
    String accion = "";
    int contador = 0;

    public frmListProgramacion4(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void tableDatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableDatosMouseClicked
        if(evt.getClickCount()==2){
            ...
            frmRegistrarControlMovimiento.txtIdProg.setText(String.valueOf(tableDatos.getValueAt(selection, 0)));
            frmRegistrarControlMovimiento.txtFechaProg.setText(String.valueOf(tableDatos.getValueAt(selection, 1)));
            frmRegistrarControlMovimiento.txtHorarioProg.setText(String.valueOf(tableDatos.getValueAt(selection, 2)));
            frmRegistrarControlMovimiento.txtBusNumProg.setText(String.valueOf(tableDatos.getValueAt(selection, 4)));
            frmRegistrarControlMovimiento.txtPlacaBusProg.setText(String.valueOf(tableDatos.getValueAt(selection, 5)));
            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmListProgramacion4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmListProgramacion4 dialog = new frmListProgramacion4(new javax.swing.JFrame(), true);
    ...
    public void cargarDatos() {
        ...
        List<Object> datos = proDAO.buscarProgramacion(txtBuscar.getText(),2);
