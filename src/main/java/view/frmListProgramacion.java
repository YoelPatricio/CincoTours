...
public class frmListProgramacion extends javax.swing.JDialog {

    DefaultTableModel dtm;
    String accion = "";
    int contador = 0;

    public frmListProgramacion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void tableDatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableDatosMouseClicked
        if(evt.getClickCount()==2){
            ...
            frmVentaBoleto.txtIdProg.setText(String.valueOf(tableDatos.getValueAt(selection, 0)));
            frmVentaBoleto.txtFechaProg.setText(String.valueOf(tableDatos.getValueAt(selection, 1)));
            frmVentaBoleto.txtHorarioProg.setText(String.valueOf(tableDatos.getValueAt(selection, 2)));
            frmVentaBoleto.txtBusNumProg.setText(String.valueOf(tableDatos.getValueAt(selection, 4)));
            frmVentaBoleto.txtPlacaBusProg.setText(String.valueOf(tableDatos.getValueAt(selection, 5)));
            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmListProgramacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmListProgramacion dialog = new frmListProgramacion(new javax.swing.JFrame(), true);
