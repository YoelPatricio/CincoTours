...
public class frmListProgramacion2 extends javax.swing.JDialog {

    DefaultTableModel dtm;
    String accion = "";
    int contador = 0;

    public frmListProgramacion2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void tableDatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableDatosMouseClicked
        if(evt.getClickCount()==2){
            ...
            frmRegistrarBoletos.txtIdProg.setText(String.valueOf(tableDatos.getValueAt(selection, 0)));
            frmRegistrarBoletos.txtFechaProg.setText(String.valueOf(tableDatos.getValueAt(selection, 1)));
            frmRegistrarBoletos.txtHorarioProg.setText(String.valueOf(tableDatos.getValueAt(selection, 2)));
            frmRegistrarBoletos.txtBusNumProg.setText(String.valueOf(tableDatos.getValueAt(selection, 4)));
            frmRegistrarBoletos.txtPlacaBusProg.setText(String.valueOf(tableDatos.getValueAt(selection, 5)));
            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmListProgramacion2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmListProgramacion2 dialog = new frmListProgramacion2(new javax.swing.JFrame(), true);
